...
<html>
    ...
    <body>
        <div class="container">
            ...
            box-shadow:10px 10px 10px -1px rgba(10,99,169,0.16),-10px -10px 10px -1px rgba(269,267,269,0.70);"><a href="datain3.php">ADD DATA</a></button>
             <button style="margin:12px 10px;
            ...
            <table class="table" style="border-spacing:50px 20px;text-algin:center;box-shadow:-1px 12px 12px;border-radius:50px;">
            ...
            if($result){
                while($row=mysqli_fetch_assoc($result)){
                     ...
                     <td>'.$reachedtime.'</td>
                     <td>'.$fare.'</td>
                     <td><button><a href="update3.php? updateid='.$id.'" style="color:darkblue">UPDATE</a></button>
            <button><a href="delete3.php?
